...
public class ConsultaControllerTest {
	...
	public ConsultaControllerTest(MockMvc mvc, JacksonTester<DadosAgendamentoConsulta> dadosAgendamentoConsultaJson,
								  JacksonTester<DadosDetalhamentoConsulta> dadosDetalhamentoConsultaJson) {
		this.mvc = mvc;
		this.dadosAgendamentoConsultaJson = dadosAgendamentoConsultaJson;
		this.dadosDetalhamentoConsultaJson = dadosDetalhamentoConsultaJson;
	}
